...
func main() {
	displayMenu := func() {
		...
		fmt.Println("1) Calculator grade")
	...
	for running {
		...
		case 2:
			...
			fmt.Println("Your status :", result)
		case 3:
			fmt.Println("Exiting program...")
			running = false
		default:
			fmt.Println("Choose a valid option for the menu")
		}
	}
}

func calculatorGrade(score int) string {
